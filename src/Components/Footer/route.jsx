            ...
            <footer className="footer">
                <section className="container footer__section">
                    <div className="footer__section__div">
                        <h1 className="footer__section__div__heading">
                            Learning Now!
                        </h1>
                        <p className="footer__section__div__paragraph">By the same illusion which lifts the horizon of the sea to the level of the spectator.</p>
                    </div>
